package com.flutterbeacon.custom;
 ...
 */
@TargetApi(21)
public class CustomBeaconTransmitter {
...
//    private AdvertiseCallback mAdvertiseCallback;
     ...
     */
    public CustomBeaconTransmitter(Context context, BeaconParser parser) {
    ...
    public void startAdvertising(Beacon beacon, AdvertiseCallback callback) {
        ...
        Log.e(TAG, "Starting advertising with ID1: " + mBeacon.getId1() + " ID2: " + mBeacon.getId2() + " ID3: " + mBeacon.getId3());
    ...
    public void startAdvertising() {
        ...
        Log.d(TAG, "Starting advertising with ID1: " + mBeacon.getId1() + " ID2: " + mBeacon.getId2() + " ID3: " + mBeacon.getId3() + " and data: " + byteString + " of size " + advertisingBytes.length);
        ...
        try{
            ...
            mBluetoothLeAdvertiser.startAdvertising(settingsBuilder.build(), dataBuilder.build(), mAdvertisingClientCallback);
//            Log.d(TAG, "Started advertisement with callback: %s", getAdvertiseCallback());
            Log.d(TAG, "Started advertisement");

        } catch (Exception e){
            Log.e(TAG, "Cannot start advertising due to exception", e);
        }
    }
    ...
    public void stopAdvertising(AdvertiseCallback callback) {
        // if (!mStarted) {
        //     Log.e(TAG, "Skipping stop advertising -- not started");
        //     return;
        // }
        Log.e(TAG, "Stopping advertising with object" + mBluetoothLeAdvertiser);
        try {
            mBluetoothLeAdvertiser.stopAdvertising(callback);
        }
        catch (IllegalStateException e) {
            Log.e(TAG, "Bluetooth is turned off. Transmitter stop call failed.");
        }
...
//                    Log.e(TAG,"Advertisement start failed, code: %s", errorCode);
